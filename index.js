...
xhr.open('GET', 'https://newsapi.org/v2/top-headlines?country=in&apiKey=e703961b2d7f4b5daeaf20c1a411ef3d', true);
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="flush-heading${index}">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                 ...
                 <span style="color:rgb(99, 79, 59) ;"> ${element["title"]} </span>
                </button>
              </h2>
